...
function pruneOldDataIfNewDay() {
  ...
  // usage_hourly 同样按 400 天清理(同期限)。保留期不能低于约 380 天:读取端的
...
const REQUEST_DATA_TABLES = ["users", "usage_daily", "usage_daily_model", "usage_daily_hourly", "usage_model", "usage_hourly", "usage_session", "errors", "quota_adjust_history", "quota_daily_ops"];
