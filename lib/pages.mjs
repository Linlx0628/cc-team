...
<div class="section">
  ...
  <div class="row" style="grid-template-columns:1fr 1fr;gap:10px">
    ...
    <div><label>账号（留空 = 匿名发信）</label><input type="text" id="notifSmtpUser" placeholder="review@your-domain.com" style="font-family:var(--font-mono);font-size:11px"></div>
    <div><label>密码 / 授权码 <span class="lbl-hint">(留空 = 不修改)</span></label><input type="password" id="notifSmtpPass" placeholder="••••••••" autocomplete="new-password" style="font-family:var(--font-mono);font-size:11px"></div>
...
<div class="section">
  ...
  <div class="row" style="margin-top:10px">
    ...
    <div><label>密钥 <span class="lbl-hint">(留空 = 不修改;空 = Webhook 功能关闭)</span></label>
      <div style="display:flex;gap:6px">
        <input type="password" id="crWebhookSecret" placeholder="••••••••" autocomplete="new-password" style="flex:1">
...
// 下发给页面的通知配置:**剔除 SMTP 密码**(改用 hasSmtpPass 标记「已保存」),
// 页面上密码框永远不回显,留空即表示不修改。
...
<aside class="dash-side">
  ...
  <nav class="sidebar-nav" id="dashNav" role="tablist" aria-label="功能菜单">
    ...
    <button type="button" class="nav-btn" role="tab" id="workspace-tab-users" aria-controls="workspace-panel-users" aria-selected="false" tabindex="-1" data-section="users">${DICO.users}用户用量<span class="workspace-tab-count" id="workspaceCountUsers">0</span></button>
    <button type="button" class="nav-btn" role="tab" id="workspace-tab-clients" aria-controls="workspace-panel-clients" aria-selected="false" tabindex="-1" data-section="clients">${DICO.clients}客户端用量<span class="workspace-tab-count" id="workspaceCountClients">0</span></button>
    <button type="button" class="nav-btn" role="tab" id="workspace-tab-detail" aria-controls="workspace-panel-detail" aria-selected="false" tabindex="-1" data-section="detail">${DICO.detail}明细记录<span class="workspace-tab-count" id="workspaceCountDetail">0</span></button>
    <button type="button" class="nav-btn" role="tab" id="workspace-tab-profiles" aria-controls="workspace-panel-profiles" aria-selected="false" tabindex="-1" data-section="profiles">${DICO.profiles}方案中心<span class="workspace-tab-count" id="workspaceCountProfiles">0</span></button>
    <button type="button" class="nav-btn" role="tab" id="workspace-tab-rates" aria-controls="workspace-panel-rates" aria-selected="false" tabindex="-1" data-section="rates">${DICO.rates}配额倍率<span class="workspace-tab-count" id="workspaceCountRates">0</span></button>
    <button type="button" class="nav-btn" role="tab" id="workspace-tab-errors" aria-controls="workspace-panel-errors" aria-selected="false" tabindex="-1" data-section="errors">${DICO.errors}错误记录<span class="workspace-tab-count" id="workspaceCountErrors">0</span></button>
...
<section class="chart-workspace" aria-label="用量图表">
  ...
  <div class="chart-panel chart-profile"><div class="chart-head"><h2>方案请求情况</h2><span class="chart-note" id="profileNote"></span></div><div class="chart-canvas"><canvas id="profileChart"></canvas></div></div>
    ...
    ${reviewDetailDialog("crDetailDlg", `<a class="pager-btn" id="crDetailExport" href="#" style="display:none">导出报告</a>`)}
...
${reviewDetailDialog("mrDetailDlg")}
