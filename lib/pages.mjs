...
<div class="box" id="sessBox" style="display:none"><h3>会话使用情况 <span style="font-size:11px;color:var(--dim);font-weight:400">会话是使用习惯的最小单位 · 长会话连续用更省缓存</span></h3><div class="cards" id="sessSummary" style="margin-bottom:8px"></div><div id="sessBoard"></div><div class="note" id="sessNote" style="font-size:11px;color:var(--dim);margin-top:8px"></div></div>
</div>
