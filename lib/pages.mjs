...
<header class="command-bar">
  ...
  <div class="controls"><select id="profileSel" aria-label="查看方案" onchange="switchProfileView(this.value)"><option value="">全部方案</option></select><a href="/settings">设置</a><a href="/wiki/" target="_blank">文档</a><button id="autoRefreshBtn" class="ar-on">自动刷新：开</button><button onclick="fetch('/api/logout',{method:'POST',headers:{'x-csrf-token':(document.cookie.match(/tm_csrf=([^;]+)/)||[])[1]||''}}).then(()=>toastThen('已退出登录',()=>location.reload()))">退出</button></div>
</header>
...
<section class="data-workspace" aria-label="数据工作区">
  <div class="workspace-tabs" role="tablist" aria-label="数据视图">
    ...
    <button id="workspace-tab-clients" role="tab" aria-controls="workspace-panel-clients" aria-selected="false" tabindex="-1" class="workspace-tab">客户端用量<span class="workspace-tab-count" id="workspaceCountClients">0</span></button>
    ...
    <button id="workspace-tab-production" role="tab" aria-controls="workspace-panel-production" aria-selected="false" tabindex="-1" class="workspace-tab">产出质量</button>
    <button id="workspace-tab-sessions" role="tab" aria-controls="workspace-panel-sessions" aria-selected="false" tabindex="-1" class="workspace-tab">会话使用情况</button>
    ...
    <button id="workspace-tab-review" role="tab" aria-controls="workspace-panel-review" aria-selected="false" tabindex="-1" class="workspace-tab">代码评审</button>
  </div>
  <div class="workspace-content">
    ...
    <section id="workspace-panel-clients" role="tabpanel" aria-labelledby="workspace-tab-clients" class="workspace-panel" hidden><div class="workspace-panel-inner">
    ...
    <section id="workspace-panel-sessions" role="tabpanel" aria-labelledby="workspace-tab-sessions" class="workspace-panel" hidden><div class="workspace-panel-inner">
    ...
    <section id="workspace-panel-review" role="tabpanel" aria-labelledby="workspace-tab-review" class="workspace-panel" hidden><div class="workspace-panel-inner">
