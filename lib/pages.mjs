...
<nav class="sidebar-nav" id="myUsageNav" role="tablist" aria-label="功能菜单"><button type="button" class="nav-btn active" role="tab" id="mu-tab-overview" aria-controls="mu-panel-overview" aria-selected="true" data-section="overview">概览</button><button type="button" class="nav-btn" role="tab" id="mu-tab-rates" aria-controls="mu-panel-rates" aria-selected="false" tabindex="-1" data-section="rates">配额价目表</button><button type="button" class="nav-btn" role="tab" id="mu-tab-analysis" aria-controls="mu-panel-analysis" aria-selected="false" tabindex="-1" data-section="analysis">用量分析</button><button type="button" class="nav-btn" role="tab" id="mu-tab-leaderboard" aria-controls="mu-panel-leaderboard" aria-selected="false" tabindex="-1" data-section="leaderboard">团队排行榜</button></nav>
<nav class="sidebar-nav" style="flex:none;padding-top:0" aria-label="快捷入口"><a class="nav-btn" href="/setup/${escJs(virtualKey)}" style="text-decoration:none">配置 Codex</a></nav>
</aside>
<main class="main">
