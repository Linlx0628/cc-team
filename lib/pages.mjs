...
<div class="section">
  ...
  <div style="overflow-x:auto">
    <table><thead><tr><th>名称</th><th>来源</th><th>地址 / 路径</th><th>分支</th><th>凭据</th><th>定时</th><th>在线触发</th><th>操作</th></tr></thead>
  ...
  <div id="crRepoEditor" hidden style="margin-top:12px;padding-top:12px;border-top:1px dashed var(--border)">
    ...
    <div class="row" style="margin-top:10px">
      ...
      <div><label>分支</label><input type="text" id="crRepoBranch" placeholder="main"></div>
    </div>
    <div class="row" style="margin-top:10px">
...
<div class="section">
  <label>在线触发授权 <span class="lbl-hint">(勾选的成员可以用自己的虚拟 Key 通过 API / MCP 触发评审;默认全不勾)</span></label>
  <div style="overflow-x:auto;margin-top:6px">
    <table><thead><tr><th style="width:40px">授权</th><th>成员</th><th>虚拟 Key</th></tr></thead>
    <tbody id="crApiKeyBody"></tbody></table>
  </div>
</div>
...
<section class="data-workspace" aria-label="数据工作区">
  ...
  <div class="workspace-content">
    ...
    <section id="workspace-panel-review" role="tabpanel" aria-labelledby="workspace-tab-review" class="workspace-panel" hidden><div class="workspace-panel-inner">
      ...
      <div class="lb-note" id="crPanelNote"></div>
      <div id="crPanelBody"><div class="lb-msg">加载中…</div></div>
    </div></section>
</main>
<script src="${assets.url("ui.js")}"><\/script>
...
// 两者缺省都按空处理,旧调用点不破。
export function personalUsageHtml(d, virtualKey, codex, claude) {
  const { assets } = d;
