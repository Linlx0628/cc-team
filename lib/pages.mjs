...
<section class="data-workspace" aria-label="数据工作区">
  <div class="workspace-tabs" role="tablist" aria-label="数据视图">
    ...
    <button id="workspace-tab-sessions" role="tab" aria-controls="workspace-panel-sessions" aria-selected="false" tabindex="-1" class="workspace-tab">会话使用情况<span class="workspace-tab-count" id="workspaceCountSessions">—</span></button>
  ...
  <div class="workspace-content">
    ...
    <section id="workspace-panel-sessions" role="tabpanel" aria-labelledby="workspace-tab-sessions" class="workspace-panel" hidden><div class="workspace-panel-inner">
      ...
      <div class="workspace-panel-scroll">
        ...
        <table id="sessTable"><thead><tr><th>成员</th><th>项目</th><th>会话</th><th>时段</th><th class="n">轮数</th><th class="n">Token</th><th class="n">缓存率</th><th class="n">单轮新增</th><th class="n">工具</th><th class="n">文件</th><th class="n">净产出</th><th class="n">失败率</th><th>分档</th></tr></thead><tbody></tbody></table>
